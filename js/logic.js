...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      angular: "Angular App",
      angularDescription: `A JavaScript quiz app built with Angular. Comming soon ...`,
    ...
    ru: {
      ...
      angularDescription: `JavaScript-приложение, созданное с использованием Angular. В процессе...`,
